...
دانشجو: ممنون، خیلی درس می‌خونم!`,
  ...
  // ─── Lesson 3 ─────────────────────────────────────────────────────────────
  {
    ...
    listening: [
      {
        id: 'l3-1', lessonId: 3, title: 'Descrivi la tua famiglia', titleFa: 'خانواده‌ات را توصیف کن',
...
گارسون: خواهش می‌کنم، روز خوبی داشته باشید!`,
    ...
    listening: [
      {
        id: 'l4-1', lessonId: 4, title: 'Ordine al bar', titleFa: 'سفارش در کافه',
...
بار: یه یورو خرده‌ات. ممنون و عصر بخیر!`,
  ...
  // ─── Lesson 5 ─────────────────────────────────────────────────────────────
  {
    ...
    listening: [
      {
        id: 'l5-1', lessonId: 5, title: 'Che ore sono?', titleFa: 'ساعت چنده؟',
...
B: موفق باشی!`,
  ...
  // ─── Lessons 6-10 (compact but complete) ─────────────────────────────────
  {
    ...
    listening: [
      {
        id: 'l6-1', lessonId: 6, title: 'Dov\'è la farmacia?', titleFa: 'داروخانه کجاست؟',
...
رهگذر: خواهش می‌کنم، روز بخیر!`,
...

  {
    ...
    listening: [
      {
        id: 'l7-1', lessonId: 7, title: 'Cosa fai nel weekend?', titleFa: 'آخر هفته چی‌کار می‌کنی؟',
...
B: چه خوب! منم می‌خوام امتحان کنم!`,
...

  {
    ...
    listening: [
      {
        id: 'l8-1', lessonId: 8, title: 'Al mercato', titleFa: 'در بازار',
...
میوه‌فروش: پنجاه سنت خرده‌ات. ممنون و روز بخیر!`,
...

  {
    ...
    listening: [
      {
        id: 'l9-1', lessonId: 9, title: 'Previsioni del tempo', titleFa: 'پیش‌بینی آب و هوا',
...

  {
    ...
    listening: [
      {
        id: 'l10-1', lessonId: 10, title: 'Racconta il tuo weekend', titleFa: 'آخر هفته‌ات را تعریف کن',
